...
void FTriangleGeometry::AddTriangle(const FVector& v0, const FVector& v1, const FVector& v2, const FVector4& Color)
{
	AddLine(Start, End, InColor, InColor);
}

void FTriangleGeometry::AddTriangle(const FVector& v0, const FVector& v1, const FVector& v2, const FVector4& StartColor, const FVector4& EndColor)
{
...
void FTriangleGeometry::AddAABB(const FBoundingBox& Box, const FColor& InColor)
{
...
void FTriangleGeometry::AddWorldHelpers(const FShowFlags& ShowFlags, float GridSpacing, int32 GridHalfLineCount,
